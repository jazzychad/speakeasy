...
// generate keys, get them back in their hexadecimal, and base32 representations.
...
//        .encoding(='base32')   key encoding (hex, or base32)
//
...
//
// Generates a random key with cryptographically random bytes of any length
// (default 32). Returns the key in hexadecimal, and base32 format.
...
speakeasy.generate_key = function(options) {
  ...
  // return a SecretKey with hex, and base32
  var SecretKey = {};
